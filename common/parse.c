...
/* * Added for WEBIRC support
 * Ensure the prototype is known if not yet in s_externs.h
 */
...
{ "WEBIRC",   4, MPAR, { _m(m_nop), _m(m_nop), _m(m_nop), _m(m_nop), _m(m_webirc) } },
...
#endif
#ifdef CHANJUPE
{ "RESV",     2, MPAR, { _m(m_nop), _m(m_nopriv), _m(m_resv), _m(m_nop), _m(m_unreg) } },
#endif
#ifdef KLINE
