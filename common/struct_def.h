...
#ifdef HELLOVERRIDE
#define HELLOLEN (BUFSIZE - (HOSTLEN + 10)) /* ":HOSTLEN 020 * :\n" (checked against less-than, so still room for terminating \0) -- mh 2020-05-12 */
#endif
/*
...
#ifdef CHANJUPE
#define CONF_CHANJUPE  		0x4000000
#define CONF_CHANJUPE_CREATE    0x8000000
#endif
...
#ifdef CHANJUPE
#define MODE_JUPED  0x40000
#ifndef CMZ_LOCAL
#define MODE_FLAGS  0x7ffff
#else
#define MODE_SECUREONLY   0x80000
#define MODE_ISSECUREONLY 0x100000
#define MODE_FLAGS  0x1fffff
#endif
#else
#ifdef CMZ_LOCAL
#define MODE_SECUREONLY   0x40000
#define MODE_ISSECUREONLY 0x80000
...
#ifdef CMZ_LOCAL
/* is channel secure clients only mode (+z or +Z) only works for local channels -- mh 2020-05-14 */
#define IsChCMZ(x)  (((x)->mode.mode & MODE_ISSECUREONLY) || ((x)->mode.mode & MODE_SECUREONLY))
#endif
...
#define ACL_CHANJUPE		0x1000000
#define ACL_CHANJUPE_JOIN	0x2000000

#define ACL_ALL_REMOTE		(ACL_KILLREMOTE|ACL_SQUITREMOTE|ACL_CONNECTREMOTE)
#define ACL_ALL			0x31FFFFF
...
#define CCL_STATS    0x20   /* clients doing stats */
#define CCL_CHANJUPE 0x40   /* channel jupe messages */
